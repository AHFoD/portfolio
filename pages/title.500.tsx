...
export default function Title500() {
  return (
    <Head>
      ...
      />
      <title>500: internal server error | Muhammad Ali Zulfaqar</title>
      <meta
        name="description"
      ...
      <meta
        name="keywords"
        content="500, internal server error, Muhammad Ali Zulfaqar, Portfolio,broken link ,missing page,link not found"
      />
    </Head>
  );
}
