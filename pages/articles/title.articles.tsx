...
export default function TitleArticles() {
  return (
    <Head>
      ...
      />
      <title>Articles by Muhammad Ali Zulfaqar</title>
      <meta
        name="description"
        content="Explore articles authored by Muhammad Ali Zulfaqar, a Full Stack Engineer and Developer."
      />
