...
export default function Title404() {
  return (
    <Head>
      ...
      />
      <title>404 - Page Not Found | Muhammad Ali Zulfaqar</title>
      <meta
        name="description"
      ...
      <meta
        name="keywords"
        content="404, Page Not Found, Muhammad Ali Zulfaqar, Portfolio,broken link ,missing page,link not found"
      />
    </Head>
  );
}
